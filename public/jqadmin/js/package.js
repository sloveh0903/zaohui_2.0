...
layui.define(['jquery', 'tags', 'layedit', 'jqform', 'upload','modal'], function(exports) {
    var $ = layui.jquery,
    ...
    layui.upload({
        ...
        success: function(res) {
            if (res.status == 1) {
                box.next('div').find('div.imgbox').html('<img src="' + res.image_name + '" alt="..." style="height: 60px">');
