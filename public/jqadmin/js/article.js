...
layui.define(['jquery','ajax', 'layedit', 'jqform', 'webuploader', 'layer'], function(exports) {
    var $ = layui.jquery,
    ...
    uploader = WebUploader.create({
        ...
        server: '/admin/Upload/articleUpload',
        fileNumLimit: 3,
    ...
    uploader.on('uploadSuccess', function(file, ret) {
        //console.log(file);
        var hidden = $("#"+file.id).find('.filehidden');
        var photopath = "";
        var path = "";
        if(ret.status == "1"){
            photopath = "<input type='hidden' name='photopath["+file.id+"]' value='"+ret.image_name+"'>";
            $(photopath).appendTo(hidden);
        }
    });
