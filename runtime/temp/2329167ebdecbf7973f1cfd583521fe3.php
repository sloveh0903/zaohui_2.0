<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"C:\php\zaohui_2.0/application/admin\view\package\edit_package.html";i:1520850498;s:59:"C:\php\zaohui_2.0/application/admin\view\common\header.html";i:1519891268;s:58:"C:\php\zaohui_2.0/application/admin\view\common\admin.html";i:1519891268;s:60:"C:\php\zaohui_2.0/application/admin\view\common\version.html";i:1519891268;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	            ...
	            <section class="panel panel-padding">
	                <form id="form1" class="layui-form layui-form-pane" action="<?php echo url('edit_package'); ?>">
						...
						<div class="layui-form-item ">
							...
							<div class="layui-input-block">
								<input type="text" name="insur_price" required jq-verify="required" value="<?php echo $package['insur_price']; ?>" jq-error="请输入价格" placeholder="￥" autocomplete="off" autocomplete="off" class="layui-input ">
							</div>
						</div>
	                    <div class="layui-form-item">
	                        <div class="layui-input-block">
