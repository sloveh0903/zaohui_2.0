   ...
   <div class="right_side_content ">
    	...
    	<div class="add_article_main ">	
    		 <div class="breadcrumb">
	              <a href='<?php echo url("poster/index"); ?>'>营销海报</a>
	              /
	              <span>设置海报</span>
	        </div>
	        ...
	        <div class="courseInfo_fill">
		        <section class="panel panel-padding">
		            <form id="form1" class="layui-form layui-form-pane" action="<?php echo url('add_poster'); ?>">
		                <input type="hidden" name="cid" value="<?php echo $cid; ?>">
		                <div class="layui-form-item">
		                    <label class="layui-form-label">海报图*</label>
		                    <div class="layui-input-block">
		                        <input type="file" name="file" class="layui-upload-file">
		                        <input type="hidden" value="<?php echo $course['poster']; ?>" name="poster" jq-verify="required" jq-error="请上传图片" error-id="big-error">
		                        <p class="upload-info">图片尺寸：750*1334 支持格式：JPG PNG</p>
		                        <p id="big-error" class="error" style="margin-left: 300px;"></p>
		                    </div>
		                    <?php if($course['poster']): ?>
		                    <div class="layui-input-block">
		                        <div class="imgbox">
		                            <img src="<?php echo $course['poster']; ?>" name="poster" alt="" class="img-thumbnail" style="width:60px;height:60px;">
		                        </div>
		                    </div>
		                    <?php endif; ?>
		                </div>
		                <div class="layui-form-item">
		                    ...
		                    <div class="layui-input-inline">
		                        <input type="radio" name="poster_audit" title="启用" value="1" <?php if($course['poster_audit'] == 1): ?>checked<?php endif; ?> />
		                        <input type="radio" name="poster_audit" title="禁用" value="2" <?php if($course['poster_audit'] == 2): ?>checked<?php endif; ?> />
		                    </div>
		                </div>
		                <div class="layui-form-item">
		                    <div class="layui-input-block">
