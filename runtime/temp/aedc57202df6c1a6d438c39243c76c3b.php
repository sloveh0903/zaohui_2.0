<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"C:\php\zaohui_2.0/application/admin\view\course\edit_course.html";i:1520848732;s:59:"C:\php\zaohui_2.0/application/admin\view\common\header.html";i:1519891268;s:58:"C:\php\zaohui_2.0/application/admin\view\common\admin.html";i:1519891268;s:60:"C:\php\zaohui_2.0/application/admin\view\common\version.html";i:1519891268;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <section class="panel panel-padding">
                <form id="form1" class="layui-form layui-form-pane" action="<?php echo url('edit_course'); ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" >
                            <input type="text" name="insur_price" required jq-verify="required" jq-error="请输入价格" placeholder="￥" autocomplete="off" value="<?php echo $course['insur_price']; ?>" autocomplete="off" class="layui-input ">
                        </div>
                    </div>
				    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" name="insur_switch" title="开启" value="1" <?php if($course['insur_switch'] == '1'): ?>checked<?php endif; ?> />
                            <input type="radio" name="insur_switch" title="关闭" value="0" <?php if($course['insur_switch'] == '0'): ?>checked<?php endif; ?> />
                        </div>
                    </div>
					<div class="layui-form-item">
