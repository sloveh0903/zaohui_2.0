    ...
    <div class="right_side_content">
        ...
        <div class="add_article_main ">
            <div class="breadcrumb">
                <a href='<?php echo url("user/index"); ?>'>后台用户管理</a>
                /
                <span>编辑用户</span>
            </div>
            ...
            <div class="articleInfo_fill">
                <section class="panel panel-padding">
                    <form id="form1" class="layui-form layui-form-pane" action='<?php echo url("user/edit_user"); ?>'>
                        <div class="layui-form-item">
                            <label class="layui-form-label">登录名*</label>
                            <div class="layui-input-inline">
                                <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                                <input type="text" name="username" <?php if($user['username'] == 'admin'): ?> readonly="readonly" <?php endif; ?> value="<?php echo $user['username']; ?>" style="width: 100%" required jq-verify="required" jq-error="" placeholder="请输入登录名" autocomplete="off" class="layui-input ">
                            </div>
                        </div>
                        <!--                     <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    ...
                                                    <input type="hidden" name="face" value="<?php echo $user['face']; ?>" jq-verify="required" jq-error="请上传头像" error-id="photo-error">
                                                    <p class="upload-info">建议尺寸：60*60 支持格式：JPG PNG</p>
                                                    <p id="photo-error" class="error"></p>
                                                </div>
                                                <div class="layui-input-block">
                                                    <div class="imgbox">
                                                        <img src="<?php echo $user['face']; ?>" name="face" alt="..." class="img-thumbnail">
                                                    </div>
                                                </div>
                                            </div> -->
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="realname" value="<?php echo $user['realname']; ?>" style="width: 100%" placeholder="姓名" autocomplete="off" class="layui-input ">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="radio" name="closed" title="启用" value="0" <?php if($user['closed'] == 0): ?>checked<?php endif; ?> />
                                <input type="radio" name="closed" title="禁用" value="1" <?php if($user['closed'] == 1): ?>checked<?php endif; ?> />
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
