<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"C:\php\zaohui_2.0/application/admin\view\package\index.html";i:1520850254;s:59:"C:\php\zaohui_2.0/application/admin\view\common\header.html";i:1519891268;s:58:"C:\php\zaohui_2.0/application/admin\view\common\admin.html";i:1519891268;s:60:"C:\php\zaohui_2.0/application/admin\view\common\version.html";i:1519891268;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script id="list-tpl" type="text/html" data-params='{"url":"<?php echo url("package/index"); ?>","pageid":"#page"}'>
	<table id="example" class="layui-table" lay-skin="line">
		...
		<tr class="courselist-tr">
			...
			<td><input type="checkbox" name="insur_switch" lay-skin="switch" lay-text="" {{#if (item.insur_switch){ }}checked="checked" {{# } }} lay-filter="ajax" data-params='{"url":"<?php echo url("package/package_insur_state"); ?>","confirm":"true","data":"id={{ item.id}}"}'></td>
