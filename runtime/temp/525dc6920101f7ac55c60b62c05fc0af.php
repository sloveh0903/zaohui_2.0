...
<!--                 <li><a href="javascript:void(0)" class="active goto" data-src='<?php echo url("ad/index"); ?>'>广告管理</a></li> -->
<!--                 <li><a href="javascript:void(0)" class="goto" data-src='<?php echo url("index/config"); ?>'>网站配置</a></li> -->
<!--            </ul> -->
<!-- 		</div> -->
<!-- 		<div class="success_tip displayNone">已完成</div> -->
	    <div class="add_article_main ">
	        <div class="breadcrumb">
	              <a href='<?php echo url("ad/index"); ?>'>广告列表</a>
	              /
	              <span>添加广告</span>
	         </div>
...
<!-- 	                	<li data-src='<?php echo url("ad/index"); ?>?id=3' class="goto <?php if($advInfo['id']==3): ?> active <?php endif; ?>" ><i data-name="pc_index">pc首页</i></li> -->
	         ...
	         <div class="articleInfo_fill">
	            <section class="panel panel-padding">
	                <form id="form1" class="layui-form layui-form-pane" action="<?php echo url('add_adv'); ?>">
	                    <div class="layui-form-item">
	                        <label class="layui-form-label">标题*</label>
	                        <div class="layui-input-inline">
	                            <input type="hidden" name="adv_id" value="<?php echo $advInfo['id']; ?>">
	                    ...
	                    <div class="layui-form-item" id='itemshow' >
	                        ...
	                        <div class="layui-input-inline">
	                            <select name="item_id"  lay-filter="item_id">
	                                ...
	                                <?php if(!empty($course)): if(is_array($course) || $course instanceof \think\Collection || $course instanceof \think\Paginator): if( count($course)==0 ) : echo "" ;else: foreach($course as $key=>$vo): ?>
	                                <option value="<?php echo $vo['cid']; ?>"><?php echo $vo['title']; ?></option>
